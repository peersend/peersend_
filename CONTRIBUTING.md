Contributing to PeerSend Core
============================

The PeerSend Core project operates an open contributor model where anyone is
...
The following applies to code changes to the PeerSend Core project, and is not to be
confused with overall PeerSend Network Protocol consensus changes.

Whether a pull request is merged into PeerSend Core rests with the project merge
...
Patches that change peersend consensus rules are considerably more involved than
...
Where a patch set proposes to change the PeerSend consensus, it must have been
...
The project leader is the release manager for each PeerSend Core release.
