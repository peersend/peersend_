...
In order to support loading of multiple wallets in peersend-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is peersend.cpp.
...
Changes to peersend.cpp
----------------------
peersend.cpp is the entry point into peersend-qt, and as such, will require some minor modifications to provide hooks for
