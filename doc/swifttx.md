...
This mechanism has been integrated into Bitcore-Node-peersend which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/peersend/insight-api-peersend#web-socket-api](https://github.com/peersend/insight-api-peersend#web-socket-api) 
* API: [https://github.com/peersend/insight-api-peersend#swifttx-transactions](https://github.com/peersend/insight-api-peersend#swifttx-transactions) 
...
By default, the PeerSend Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the PeerSend Core daemon:
