...
RESOURCES += src/qt/peersend.qrc src/qt/peersend_locale.qrc

TRANSLATIONS += src/qt/locale/peersend_bg.ts \
                src/qt/locale/peersend_de.ts \
                src/qt/locale/peersend_en.ts \
                src/qt/locale/peersend_es.ts \
                src/qt/locale/peersend_fi.ts \
                src/qt/locale/peersend_fr.ts \
                src/qt/locale/peersend_it.ts \
                src/qt/locale/peersend_ja.ts \
                src/qt/locale/peersend_pl.ts \
                src/qt/locale/peersend_pt.ts \
                src/qt/locale/peersend_ru.ts \
                src/qt/locale/peersend_sk.ts \
                src/qt/locale/peersend_sv.ts \
                src/qt/locale/peersend_vi.ts \
                src/qt/locale/peersend_zh_CN.ts \
                src/qt/locale/peersend_zh_TW.ts
