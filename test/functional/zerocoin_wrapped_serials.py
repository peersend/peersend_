#!/usr/bin/env python3
# Copyright (c) 2019 The PeerSend Core developers
...
from fake_stake.base_test import peersend_FakeStakeTest

class zpsdwrappedSerialsTest(peersend_FakeStakeTest):
    ...
    def run_test(self):
        ...
        # 2) Mint zerocoins
        self.log.info("Minting %d-denom zpsds..." % DENOM_TO_USE)
