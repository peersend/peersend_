...
#ifndef peersend_zpsdWALLET_H
#define peersend_zpsdWALLET_H
...
public:
    CzpsdWallet(std::string strWalletFile);
    ...
    void GenerateDeterministiczpsd(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedTozpsd(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
