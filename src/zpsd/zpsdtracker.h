...
#ifndef peersend_zpsdTRACKER_H
#define peersend_zpsdTRACKER_H
...
public:
    CzpsdTracker(std::string strWalletFile);
    ~CzpsdTracker();
    void Add(const CDeterministicMint& dMint, bool isNew = false, bool isArchived = false, CzpsdWallet* zpsdWallet = NULL);
