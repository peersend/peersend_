 ...
 * for both peersendd and peersend-qt, to make it harder for attackers to
 * target servers or GUI users specifically.
 */
const std::string CLIENT_NAME("PeerSend Core");
...
/**
 * Split the Sub Version string such as /PeerSend Core:x.y.z/
