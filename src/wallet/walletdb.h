...
public:
    ...
    bool WritezpsdSeed(const uint256& hashSeed, const vector<unsigned char>& seed);
    bool ReadzpsdSeed(const uint256& hashSeed, vector<unsigned char>& seed);
    bool ReadzpsdSeed_deprecated(uint256& seed);
    bool ErasezpsdSeed();
    bool ErasezpsdSeed_deprecated();

    bool WritezpsdCount(const uint32_t& nCount);
    bool ReadzpsdCount(uint32_t& nCount);
