...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("PeerSend Core peersend-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  peersend-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded peersend transaction") + "\n" +
                               "  peersend-tx [options] -create [commands]   " + _("Create hex-encoded peersend transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded peersend transaction
