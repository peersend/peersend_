...
/** Utility functions used by the peersend Qt UI.
 */
namespace GUIUtil
{
...
// Render peersend addresses in monospace font
...
// Parse "peersend:" URI into recipient object, return true on successful parsing
