                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzpsdPathCustom = GetArg("-zpsdbackuppath", "");
    ...
    if(!strzpsdPathCustom.empty()) {
        ui->wallet_customzpsdbackuppath->setText(QString::fromStdString(strzpsdPathCustom));
        ui->wallet_customzpsdbackuppath_label->setVisible(true);
        ui->wallet_customzpsdbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzpsdPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the PeerSend RPC console.") + "<br>" +
