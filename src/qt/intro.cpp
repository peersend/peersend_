...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("PeerSend Core"),
     ...
     * override -datadir in the peersend.conf file in the default data directory
     * (to be consistent with peersendd behavior)
     */
    if (dataDir != getDefaultDataDirectory())
