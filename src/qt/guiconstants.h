...
/* peersend GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "PeerSend"
#define QAPP_ORG_DOMAIN "peersendcoin.com"
#define QAPP_APP_NAME_DEFAULT "peersend-Qt"
#define QAPP_APP_NAME_TESTNET "peersend-Qt-testnet"
