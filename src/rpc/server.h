...
/**
 * peersend RPC command dispatcher.
 */
class CRPCTable
{
private:
...
extern UniValue setzpsdseed(const UniValue& params, bool fHelp);
extern UniValue getzpsdseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdzpsd(const UniValue& params, bool fHelp);
extern UniValue dzpsdstate(const UniValue& params, bool fHelp);
