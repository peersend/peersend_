...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop peersend server.");
    // Event loop will exit after current HTTP requests have been handled, so
    // this reply will get back to the client.
    StartShutdown();
    return "peersend server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* peersend features */
    //    {"peersend", "masternode", &masternode, true, true, false},
        {"peersend", "listmasternodes", &listmasternodes, true, true, false},
        {"peersend", "getmasternodecount", &getmasternodecount, true, true, false},
        {"peersend", "masternodeconnect", &masternodeconnect, true, true, false},
        {"peersend", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"peersend", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"peersend", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"peersend", "masternodecurrent", &masternodecurrent, true, true, false},
        {"peersend", "masternodedebug", &masternodedebug, true, true, false},
        {"peersend", "startmasternode", &startmasternode, true, true, false},
        {"peersend", "createmasternodekey", &createmasternodekey, true, true, false},
        {"peersend", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"peersend", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"peersend", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"peersend", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"peersend", "getmasternodescores", &getmasternodescores, true, true, false},
        {"peersend", "preparebudget", &preparebudget, true, true, false},
        {"peersend", "submitbudget", &submitbudget, true, true, false},
        {"peersend", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"peersend", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"peersend", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"peersend", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"peersend", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"peersend", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"peersend", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"peersend", "checkbudgets", &checkbudgets, true, true, false},
        {"peersend", "mnsync", &mnsync, true, true, false},
        {"peersend", "spork", &spork, true, true, false},
        {"peersend", "getpoolinfo", &getpoolinfo, true, true, false},
        ...
        {"zerocoin", "getzpsdseed", &getzpsdseed, false, false, true},
        {"zerocoin", "setzpsdseed", &setzpsdseed, false, false, true},
        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
        {"zerocoin", "searchdzpsd", &searchdzpsd, false, false, true},
        {"zerocoin", "dzpsdstate", &dzpsdstate, false, false, true},
...
{
    return "> peersend-cli " + methodname + " " + args + "\n";
}
